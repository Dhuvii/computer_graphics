      ...
      <div className="relative flex w-full flex-col justify-start">
        ...
        >
          ...
          <input
            id={id}
            ref={ref}
            className={`peer block w-full appearance-none rounded-xl border-2 bg-transparent p-3 text-sm text-gray-900 transition duration-300 focus:outline-none focus:ring-2 
          ${
            error
